              ...
              >
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-[#5f6368]">
                      I want to create campaigns and book ad space.
                    </p>
                  </div>
                </Label>

                <Label
                  htmlFor="role-broadcaster"
                  className="flex cursor-pointer items-start gap-3 rounded-2xl border border-[#d7dce3] p-4 transition hover:border-[#ffb25c] hover:bg-[#fffaf3]"
                >
                  <RadioGroupItem
                    value="broadcaster"
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-[#5f6368]">
                      I want to list spaces and manage incoming bookings.
                    </p>
                  </div>
                </Label>
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-[#5f6368]">
                      I need advertiser and broadcaster onboarding in one pass.
                    </p>
                  </div>
                </Label>
              </RadioGroup>
          ...
          {showAdvertiserFields && (
            <section className={sectionClassName}>
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm leading-6 text-[#5f6368]">
                  Based on `advertiser_profile` and `campaigns` in the backend
                  schema.
                </p>
              </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder="Adtua Coffee Co."
                    className={inputClassName}
                    required={showAdvertiserFields}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder="image, video, static billboard"
                    className={inputClassName}
                  />
                </div>
          ...
          {showBroadcasterFields && (
            <section className={sectionClassName}>
              <div className="mb-6">
                ...
                <p className="mt-2 text-sm leading-6 text-[#5f6368]">
                  Based on `broadcaster_profile` and `spaces` in the backend
                  schema.
                </p>
              </div>
              ...
              <div className="grid gap-5 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder="Adtua Media Group"
                    className={inputClassName}
                    required={showBroadcasterFields}
                  />
                </div>
                ...
                <div className="space-y-2 md:col-span-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder="coffee, students, commuters, fitness"
                    className={inputClassName}
                  />
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder="retail, outdoor, transit"
                    className={inputClassName}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={handleChange}
                    placeholder="digital screen, poster, billboard"
                    className={inputClassName}
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    id="estDailyImpressions"
                    name="estDailyImpressions"
                    type="number"
                    min="0"
                    value={formData.estDailyImpressions}
                    onChange={handleChange}
                    placeholder="2400"
                    className={inputClassName}
                  />
          ...
          <section className={sectionClassName}>
            <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
              <div>
                ...
                <p className="mt-2 text-sm leading-6 text-[#5f6368]">
                  No API call is made yet. This just simulates a successful save
                  so the UI flow is ready for backend wiring later.
                </p>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm leading-6">
                      Your onboarding information has been captured in the UI.
                      The next step will be connecting this form to the backend
                      endpoints and database writes.
                    </p>
                  </div>
                </div>
              </div>
